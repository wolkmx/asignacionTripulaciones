 ...
 * Clase utileria para guardar las listas estaticas es decir como si fuera
...
public class Almacen {
    ...
    public static Map<Integer, RegistroVuelos> registroVuelos = new HashMap<>();
    ...
    public static String[] getSimulacionesPiloto(String numeroEmpleado) {
        ...
        for (RegistroPruebasSimulacion r : registroPruebasSimulacion) {
            if (r.getPiloto() == null) {
                respuesta.add("");
            } else if (r.getPiloto().getNombre().compareTo(numeroEmpleado) == 0) {
    ...
    /**
     * Metodo publico estatico para obtener un listado de tipo string con todos
     * los numeros de vuelo existentes
     *
     * @return
     */
    ...
    /**
     * Metodo publico estatico para obtener una cadena HTML con la informacion
     * de las calificaicones de la simulacion
     *
